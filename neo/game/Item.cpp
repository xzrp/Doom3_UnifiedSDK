	...
	if ( player ) {
		...
		if ( spawnArgs.GetString( "inv_objective", NULL ) ) {
	 		if ( player->hud ) {
				...
				player->hud->SetStateString( "objectivetext", spawnArgs.GetString( "objectivetext" ) );
				player->hud->SetStateString( "objectivecompletetitle", spawnArgs.GetString( "objectivetitle" ) );	// NOTE: BFG GOES DIR IN Player->CompleteObjective
//				player->hud->SetStateString( "objectivetitle", spawnArgs.GetString( "objectivetitle" ) );		// NOTE: WAS #ELSE ( D3 (
