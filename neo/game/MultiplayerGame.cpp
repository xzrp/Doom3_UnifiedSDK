...
// NOTE ( BFG DON'T HAVE THE FOLLOWING 2 LINES	
	idStr livesinfo;
	idStr timeinfo;
	...
	while ( iline < MAX_CLIENTS ) { //Max players is now 8		// NOTE ( THIS CAME FROM D3XP, BFG IS MISSING
...
void idMultiplayerGame::UpdateHud( idPlayer *player, idUserInterface *hud ) {
	...
	for ( i = ( gameState == GAMEON ? numRankedPlayers : 0 ) ; i < MAX_CLIENTS; i++ ) {		// NOTE ( BFG DON'T HAVE THIS )
