...
/*
=================
idGuidedProjectile::Event_SetEnemy
=================
*/
...
//			idVec3 org = beamTargets[i].target.GetEntity()->GetPhysics()->GetAbsBounds().GetCenter();		// NOTE: THIS WAS WITH #ELSE
...
//				if ( damageFreq && *(const char *)damageFreq && beamTargets[i].target.GetEntity() && beamTargets[i].target.GetEntity()->CanDamage( GetPhysics()->GetOrigin(), org ) ) {		// NOTE: THIS WAS WITH #ELSE
